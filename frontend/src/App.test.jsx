...
describe('ReNova ADMET App', () => {
  it('renders the disease input field with default value', () => {
    render(<App />);
    const inputElement = screen.getByLabelText(/Disease Name/i);
  ...
  it('renders the mock mode checkbox and it is checked by default', () => {
    render(<App />);
    const checkboxElement = screen.getByLabelText(/Mock Mode/i);
  ...
  it('renders the submit button with correct text', () => {
    render(<App />);
    const buttonElement = screen.getByRole('button', { name: /Run ADMET Pipeline/i });
